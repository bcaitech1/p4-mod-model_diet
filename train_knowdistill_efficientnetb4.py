...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data", default="configs/data/taco_4_small_continue.yaml", type=str, help="data config"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--student_pretrained", default="exp/mobilenetv3_7_2021-06-13_23-36-00/best.pt",
        type=str, help="to load student pretrained weight"
    )
    # parser.add_argument(
