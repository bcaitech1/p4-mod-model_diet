...
def train_kd(
    ...
    teacher_model = Mobilenetv3_large(num_classes=9)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data", default="configs/data/taco_3.yaml", type=str, help="data config"
    )
    parser.add_argument(
        "--teacher_pretrained", default="expsaves/mobilenetv3_large_pretrained_2021-06-10_07-27-57/best.pt",
